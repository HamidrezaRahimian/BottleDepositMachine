...
public class MersennerTwisterFast implements Serializable, Cloneable {
    @Serial
    ...
    public MersennerTwisterFast() {
        this(System.currentTimeMillis());
    }

    public MersennerTwisterFast(long seed) {
        setSeed(seed);
    }

    public MersennerTwisterFast(int[] array) {
        setSeed(array);
    }

    public Object clone() {
        try {
            MersennerTwisterFast mersenneTwisterFast = (MersennerTwisterFast) (super.clone());
    ...
    public boolean stateEquals(MersennerTwisterFast other) {
        if (other == this) {
            return true;
        }
